...
<head>
    ...
    <title>Edit Event - Janjiin</title>
            ...
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm text-yellow-700 mt-1">
                        Event ini sedang aktif dan sudah memiliki peserta. Perubahan tertentu mungkin mempengaruhi peserta yang sudah mendaftar.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" value="Workshop Laravel untuk Pemula" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">Pelajari framework Laravel dari dasar hingga mahir dalam membangun aplikasi web yang powerful dan scalable.</textarea>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Deskripsi Lengkap *</label>
                        <textarea rows="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">Workshop intensif selama 8 jam ini dirancang khusus untuk developer pemula yang ingin menguasai Laravel, framework PHP terpopuler untuk pengembangan aplikasi web modern.

Anda akan belajar langsung dari praktisi berpengalaman dan membangun aplikasi web lengkap dari awal hingga deployment.</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Tanggal & Waktu</h2>
                    <div class="bg-red-50 border border-red-200 rounded-lg px-3 py-1">
                        <span class="text-red-700 text-sm">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            Perubahan akan mempengaruhi 45 peserta
                        </span>
                    </div>
                </div>
                <div class="grid md:grid-cols-2 gap-6">
